...
async function main() {
  ...
  const settings = [
    ...
    {
      key: "ccc.rawMaterialDays",
      value: "30",
      type: "INTEGER" as const,
      group: "Cash cycle",
      labelEn: "Raw material holding days",
      labelAr: "أيام تخزين الخامات",
      descriptionEn: "Days fabric waits in the store before cutting. Locked capital.",
      descriptionAr: "أيام انتظار القماش في المخزن قبل القص. رأس مال محبوس.",
    },
    {
      key: "ccc.productionLeadDays",
      value: "21",
      type: "INTEGER" as const,
      group: "Cash cycle",
      labelEn: "Production lead days",
      labelAr: "أيام دورة الإنتاج",
      descriptionEn: "Days from cutting to finished goods.",
      descriptionAr: "الأيام من القص حتى الإنتاج التام.",
    },
    {
      key: "ccc.finishedGoodsDays",
      value: "45",
      type: "INTEGER" as const,
      group: "Cash cycle",
      labelEn: "Finished goods days",
      labelAr: "أيام الإنتاج التام",
      descriptionEn: "Days garments wait on the shelf before selling.",
      descriptionAr: "أيام انتظار القطع في المخزن قبل البيع.",
    },
    {
      key: "ccc.collectionDays",
      value: "14",
      type: "INTEGER" as const,
      group: "Cash cycle",
      labelEn: "Collection days",
      labelAr: "أيام التحصيل",
      descriptionEn: "Days from sale until the cash actually arrives.",
      descriptionAr: "الأيام من البيع حتى وصول النقدية فعليًا.",
    },
    {
      key: "ccc.supplierCreditDays",
      value: "35",
      type: "INTEGER" as const,
      group: "Cash cycle",
      labelEn: "Supplier credit days",
      labelAr: "أيام ائتمان الموردين",
      descriptionEn: "Credit suppliers grant, which funds part of the cycle.",
      descriptionAr: "الائتمان الممنوح من الموردين، ويموّل جزءًا من الدورة.",
    },
    {
      ...
      type: "DECIMAL" as const,
      group: "Payroll",
      labelEn: "Overtime multiplier",
      labelAr: "معامل الأجر الإضافي",
      descriptionEn: "Applied to the ordinary minute rate for approved overtime only.",
      descriptionAr: "يُطبَّق على أجر الدقيقة العادي للوقت الإضافي المعتمد فقط.",
    },
    {
      key: "payroll.employerCostPct",
      value: "0.1875",
      type: "PERCENT" as const,
      group: "Payroll",
      labelEn: "Employer social insurance rate",
      labelAr: "نسبة التأمينات على صاحب العمل",
      descriptionEn: "Employer-side cost on top of gross pay. Confirm against current Egyptian rules.",
      descriptionAr: "تكلفة على صاحب العمل فوق الأجر الإجمالي. راجعها مع القواعد المصرية الحالية.",
    },
    {
