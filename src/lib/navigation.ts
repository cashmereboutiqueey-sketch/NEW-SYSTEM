...
export const navigation: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "minuteRate", href: "/minute-rate", phase: 2, scopes: ["FACTORY", "GROUP"], icon: "timer" },
  ...
  },
  {
    ...
    items: [
      ...
      { key: "transferPrice", href: "/costing", phase: 2, scopes: ["FACTORY", "GROUP"], icon: "calculator" },
      { key: "productionOrder", href: "/production", phase: 3, scopes: ["FACTORY", "GROUP"], icon: "factory" },
  ...
  },
  {
    key: "inventory",
    items: [
      { key: "inventory", href: "/inventory", phase: 4, scopes: ALL_SCOPES, icon: "boxes" },
